...
public class PlayerCtrl : MonoBehaviour
{
    ...
    void FixedUpdate() {
        ...
        {
            if (Input.GetButton("Jump-" + name) || Input.GetButton("Fire-" + name) || Input.GetMouseButtonDown(0))
        ...
        else if (Input.GetButton("Jump2-" + name) || Input.GetButton("Fire2-" + name) || Input.GetMouseButton(1))
        {
            nextSpread += Time.deltaTime;
