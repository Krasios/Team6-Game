...
public class playerMovement : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        //slows down if player isnt manually moving
        if (moveHorizontal == 0 && moveVertical==0 && (rb2d.velocity.x != 0 || rb2d.velocity.y != 0))
        {
                rb2d.velocity=new Vector2(rb2d.velocity.x * 0.98f, rb2d.velocity.y*0.98f);
        }
